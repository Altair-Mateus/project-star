 ...
 */
public class PesqEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form PesqEmpresa
     */
    ...
    //  Variavel para usar as consultas na pesquisa
    List<Empresacliente> lista;
    
    public PesqEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jTable_Empresa_.setCellSelectionEnabled(false);
    ...
    private void atualiza()
    {
        ...
        lista = DAO.consultaSQL(Empresacliente.class, where);
    ...
    private void initComponents() {
        ...
        jTable_Empresa_ = new javax.swing.JTable();
        ...
        jLabel_Empresas.setText("EMPRESAS");
        ...
        jTable_Empresa_.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jTable_Empresa_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTable_Empresa_MouseClicked(evt);
            }
        });
        jTable_Empresa_.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTable_Empresa_KeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(jTable_Empresa_);
    ...
    private void jTable_Empresa_KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable_Empresa_KeyPressed
        
        //  Chamando a tela de empresa e exibindo registro
        new Empresa(parent, true, lista.get(jTable_Empresa_.getSelectedRow())).setVisible(true);
        
        //  Atualizando tabela
        atualiza();
        
    }//GEN-LAST:event_jTable_Empresa_KeyPressed

    private void jTable_Empresa_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_Empresa_MouseClicked
               
    }//GEN-LAST:event_jTable_Empresa_MouseClicked
    ...
    private void jButton_IncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_IncluirActionPerformed
        ...
        new Empresa(parent, true).setVisible(true);
    ...
    private void jButton_LimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LimparActionPerformed
       ...
       DefaultTableModel table = (DefaultTableModel)jTable_Empresa_.getModel();
       table.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesqEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesqEmpresa dialog = new PesqEmpresa(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTable_Empresa_;
