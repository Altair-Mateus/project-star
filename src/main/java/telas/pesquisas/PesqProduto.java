...
public class PesqProduto extends javax.swing.JDialog {
    ...
    public PesqProduto(java.awt.Frame parent, boolean modal) {
        ...
        jTable_Produto_.setCellSelectionEnabled(false);
    ...
    }// Fim do construtor PesqProduto(java.awt.Frame parent, boolean modal)
    
    //  Método que popula a tabela
    private void atualiza()
    {
        
        String[] titulos = new String[]{"Número", "Nome", "Código de Barras", "Estoque"};
        
        lista = DAO.consultaSQL(models.Produto.class, where);
        ...
        for(int i = 0; i < lista.size(); i++)
        {
            ...
            dados[i][2] = lista.get(i).getCodBarras();
            dados[i][3] = lista.get(i).getEstoque();
            
        }// Fim do bloco de repetição for
        
        DefaultTableModel dtm = new DefaultTableModel(dados, titulos);
        
        jTable_Produto_.setModel(dtm);
    ...
    private void initComponents() {
        ...
        jLabel_Produtos.setText("PRODUTOS");
        ...
        jTable_Produto_.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Número", "Nome", "Código de Barras", "Estoque"
            }
        ));
        jTable_Produto_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTable_Produto_MouseClicked(evt);
            }
        });
        jTable_Produto_.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTable_Produto_KeyPressed(evt);
            }
        });
    ...
    private void jTable_Produto_KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable_Produto_KeyPressed
      
        //  Chamando a tela de produto e exibindo registro        
        new Produto(parent, true, lista.get(jTable_Produto_.getSelectedRow())).setVisible(true);
        
        //  Atualizando tabela
        atualiza();
        
    }//GEN-LAST:event_jTable_Produto_KeyPressed

    private void jTable_Produto_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_Produto_MouseClicked
        
        
    }//GEN-LAST:event_jTable_Produto_MouseClicked

    private void jButton_ImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirActionPerformed
        try
        {
            if (! jTable_Produto_.print())
            {
    ...
    private void jButton_LimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LimparActionPerformed
        ...
        DefaultTableModel table = (DefaultTableModel)jTable_Produto_.getModel();
        table.setRowCount(0);
    ...
    private void jButton_IncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_IncluirActionPerformed
        ...
        new Produto(parent, true).setVisible(true);
